...
function Footer() {
    return (
        <>
            <div className='mx-10 px-9 pt-20 mt-10 rounded-md glass pb-20'>
                ...
                <div className='mt-8 border-t mx-[30rem]  border-white pl-3 pt-8 flex-col items-center'>

                    <p className='text-justify'>
                        &copy; 2024 Jatin Company.
                        All right reserved.
                    </p>
